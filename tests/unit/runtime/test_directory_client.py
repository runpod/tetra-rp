...
from tetra_rp.runtime.directory_client import DirectoryClient, DirectoryUnavailableError


class TestDirectoryClient:
    """Test DirectoryClient functionality."""
    ...
    def test_init_with_url(self):
        ...
        client = DirectoryClient(mothership_url="https://mothership.example.com")
    ...
    def test_init_explicit_over_env(self):
        ...
        with patch.dict(os.environ, {"FLASH_MOTHERSHIP_URL": "https://env.com"}):
            client = DirectoryClient(mothership_url="https://explicit.com")
    ...
    async def test_get_directory_success(self, mock_response):
        ...
        with patch("tetra_rp.runtime.directory_client.httpx"):
    ...
    async def test_get_directory_http_error(self):
        ...
        with patch.object(client, "_get_client") as mock_get_client:
            ...
            with pytest.raises(DirectoryUnavailableError, match="500"):
    ...
    async def test_get_directory_retry(self):
        ...
        with patch.object(client, "_get_client") as mock_get_client:
            ...
            with patch(
                "tetra_rp.runtime.directory_client.asyncio.sleep",
    ...
    async def test_get_directory_exhaust_retries(self):
        ...
        with patch.object(client, "_get_client") as mock_get_client:
            ...
            with patch(
                ...
                with pytest.raises(DirectoryUnavailableError, match="after 2 attempts"):
                    await client.get_directory()
